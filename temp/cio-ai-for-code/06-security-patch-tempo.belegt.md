...
> _Angereicherte Fassung: zu jedem Befund wurde **Beleg im Original** (wörtlicher Quelltext aus der Archiv-Datei bzw. Online-Quelle) und **Quell-Link** ergänzt. Erzeugt aus der Originaldatei `06-security-patch-tempo.md`; Zahlen unverändert._
...
- **Beleg im Original:** Red Hat AI Inference on IBM Cloud goes GA (May 22)** — vLLM-powered, OpenAI-compatible APIs, IBM Cloud IAM/audit/privacy controls, SLA-backed. Launch model catalog: Granite 4.0 H Small, Mistral-Small-3.2-24B-Instruct, Llama 3.3 70B Instruct, GPT-OSS-120B, Nemotron-3-Nano-30B-FP8. OpenShift Virtualization Service GA'd in parallel. First major hyperscale-grade managed inference service shipping with both EU-style governance hooks and a multi-vendor open-weight catalog. …
- **Quell-Link:** https://www.anthropic.com/news/project-glasswing-update
...
- **Beleg im Original:** [BNP Paribas extends Mistral partnership 3 years — first European bank to explicitly cite Anthropic Mythos-class vulnerability discovery as sovereign-AI motivation](https://www.bloomberg.com/news/articles/2026-05-26/bnp-paribas-works-with-mistral-to-prep-for-mythos-like-ai-models)** — Tens of thousands of investment-banking staff on document extraction, equity research, internal knowledge retrieval; client-facing assistants in France/Belgium; Mistral engineers embedded in BNP teams. Novel framing: BNP states European banks "may lag US peers" without sovereign-AI access — Mistral becomes the …
- **Quell-Link:** https://www.bloomberg.com/news/articles/2026-05-26/bnp-paribas-works-with-mistral-to-prep-for-mythos-like-ai-models
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://blog.qualys.com/product-tech/2026/03/23/meet-agent-val-closing-the-validation-gap-in-exposure-management-at-machine-speed-with-agentic-ai
...
- **Beleg im Original:** AI just turned Patch Tuesday into a benchmark** — Henning Steier (en), May 13. Walks through Microsoft's May 12 disclosure that 16 of its patched vulnerabilities (4 Critical) were found by an internal multi-agent system codenamed MDASH (100+ specialised agents, ensemble of frontier+distilled models, 88.45% on CyberGym vs ~83% next entry, private preview June); ties it back to Anthropic's April 7 Claude Mythos Preview disclosure (27-yr OpenBSD bug, 16-yr FFmpeg/H.264 bug missed by ~5M fuzzer hits) and Project Glasswing (12 founding partners incl. Microsoft, AWS, Google, Cisco, CrowdStrike, …
...
- **Beleg im Original:** Anthropic launches Claude Security public beta + CrowdStrike, Palo Alto, SentinelOne, Trend Micro and Wiz embed Opus 4.7.** Anthropic opened Claude Security to public beta for Claude Enterprise customers, a dedicated defensive product powered by Opus 4.7 that reasons over entire codebases the way a security researcher does — tracing data flows, reading source, and modelling cross-file interactions. The private preview surfaced 500 production vulnerabilities in two months, including bugs that had remained invisible to expert reviews for years. Same day, CrowdStrike, Palo Alto Networks, …
- **Quell-Link:** https://siliconangle.com/2026/04/30/anthropic-announces-claude-security-public-beta-find-fix-software-vulnerabilities/
...
- **Beleg im Original:** The third thread is the same hardware story read from the other end of the wire. GitHub announced same-day that it is pausing Copilot Individual signups, tightening usage limits across the line, restricting Opus 4.7 to the new $39 Pro+ tier, and dropping older Opus models entirely. The load-bearing quote in the announcement — "long-running, parallelized sessions now regularly consume far more resources than the original plan structure was built to support" — is the cleanest market signal yet that per-request bundles cannot survive agentic workloads; the unit economics shift back to per-token. …
- **Quell-Link:** https://simonwillison.net/2026/Apr/22/bobby-holley/
...
- **Beleg im Original:** _Synthesized from per-topic collectors (backfill on 2026-05-14 — historical reconstruction). Tuesday is the enterprise-pharma + governance day of W16: **Novo Nordisk and OpenAI** strike an enterprise-wide partnership covering drug discovery, clinical trials, manufacturing, supply chains and commercial operations — full integration by end of 2026, the largest pharma-side enterprise OpenAI deal yet and the structural setup for Thursday's GPT-Rosalind launch. The same day, **Anthropic's Long-Term Benefit Trust appoints Novartis CEO Vas Narasimhan** to the Board, simultaneously bringing biopharma …
- **Quell-Link:** https://simonwillison.net/2026/Apr/14/cybersecurity-proof-of-work/
...
- **Beleg im Original:** The anchor was the AISI report on Anthropic's Claude Mythos Preview. In pre-release testing the model autonomously identified and exploited thousands of previously unknown vulnerabilities across every major OS and browser, including CVE-2026-4747, a 17-year-old NFS remote code execution flaw in FreeBSD. Anthropic withheld general access and routed Mythos instead to an eleven-partner defender consortium that runs from AWS, Apple, Broadcom, Cisco and CrowdStrike through Google, JPMorgan Chase, the Linux Foundation, Microsoft, NVIDIA and Palo Alto Networks. Fortune ran a long interview with …
- **Quell-Link:** https://www.aisi.gov.uk/blog/our-evaluation-of-claude-mythos-previews-cyber-capabilities
...
- **Quell-Link:** https://jack-clark.net/2026/04/06/import-ai-452-scaling-laws-for-cyberwar
...
- **Quell-Link:** https://blog.calif.io/p/mad-bugs-claude-wrote-a-full-freebsd
...
- **Quell-Link:** https://fortune.com/2026/03/27/anthropic-leaked-ai-mythos-cybersecurity-risk/
...
- **Beleg im Original:** Google Cloud launches AI Threat Defense — frontier-lab cybersecurity triumvirate complete** — Always-on platform combining Gemini, Wiz, CodeMender, Mandiant. Four-part framework (prepare → scan/prioritize → remediate → monitor) explicitly competes with Anthropic Mythos and OpenAI Daybreak. Every Tier-1 lab now sells an AI-native SOC; cyberdefense is now the most contested vertical for frontier-lab enterprise GTM. ([Help Net Security](https://www.helpnetsecurity.com/2026/05/27/google-ai-threat-defense-released/) · …
- **Quell-Link:** https://www.helpnetsecurity.com/2026/05/27/google-ai-threat-defense-released/
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://www.securityweek.com/m-trends-2026-initial-access-handoff-shrinks-from-hours-to-22-seconds/
...
- **Beleg im Original:** OpenAI launches Daybreak — GPT-5.5 + GPT-5.5-Cyber + Trusted Access for Cyber** — OpenAI launched Daybreak, an AI-powered cyber-defence platform built on a three-tier model lineup: GPT-5.5 (general purpose, standard safeguards), GPT-5.5 with Trusted Access for Cyber (verified defensive work in authorised environments — secure code review, vulnerability triage, malware analysis, detection engineering, patch validation), and GPT-5.5-Cyber (a permissive variant for red teaming, pentesting, controlled validation). Day-one partners under Trusted Access: Akamai, Cisco, Cloudflare, CrowdStrike, …
- **Quell-Link:** https://openai.com/daybreak/
...
- **Verifizierung:** nicht einzeln verifiziert
- **Art:** Kontext
- **Beleg im Original:** "Mandiant's 2024 data showed an average of -1 day, meaning exploitation now routinely occurs before the patch even exists." … "In 2025, more than 48,000 CVEs were published."
- **Quell-Link:** https://blog.qualys.com/product-tech/2026/03/23/meet-agent-val-closing-the-validation-gap-in-exposure-management-at-machine-speed-with-agentic-ai
- **Beleg-Notiz:** Confirmed: the named Qualys blog post (2026-03-23, "Meet Agent Val") contains both the -1 day time-to-exploit claim and the 48,000+ CVEs (2025) figure, matching the dedupe cross-reference to the 2026-03-23 Agent Val finding.
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://xbow.com/blog/top-1-how-xbow-did-it
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://cloud.google.com/blog/products/identity-security/cloud-ciso-perspectives-our-big-sleep-agent-makes-big-leap
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://www.first.org/newsroom/releases/20260211
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://jerrygamblin.com/2026/01/01/2025-cve-data-review/
