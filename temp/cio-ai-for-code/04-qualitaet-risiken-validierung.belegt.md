...
> _Angereicherte Fassung: zu jedem Befund wurde **Beleg im Original** (wörtlicher Quelltext aus der Archiv-Datei bzw. Online-Quelle) und **Quell-Link** ergänzt. Erzeugt aus der Originaldatei `04-qualitaet-risiken-validierung.md`; Zahlen unverändert._
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://cybersecuritydive.com/news/shadow-ai-employee-trust-upguard/805280/
...
- **Beleg im Original:** Ontario auditors find doctors' AI note takers routinely blow basic facts — 305 pts · 137 comments. 60% of audited AI scribe systems mix up prescribed drugs.
- **Quell-Link:** https://news.ycombinator.com/item?id=48142188
- **Beleg-Notiz:** Found in daily/2026/05/2026-05-16.md at line 119. The finding appears in two places in this document: in the briefing summary (line 10) and in the Hacker News pulse section (line 119). The HN link points to the original story discussing Ontario auditors' findings on medical AI scribe systems.
...
- **Quell-Link:** https://linkedin.com/pulse/ki-ist-angekommen-aber-nicht-bei-allen-paul-meyrat-5ltxe
...
- **Beleg im Original:** % of developers cite missing or rotted context as the leading cause of poor AI code quality, ahead of model capability and framework choice
- **Quell-Link:** https://medium.com/@codewithrashid/context-engineering-has-eaten-prompt-engineerin-eb3a869c0362
- **Beleg-Notiz:** Found in /data/blogs/2026/05/2026-05-21.md line 61 (also present in 05-22, 05-23, 05-24 as specified in FUNDSTELLE). The verbatim English version appears in the archive; German translation matches the BEFUND claim.
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://fortune.com/2025/08/18/mit-report-95-percent-generative-ai-pilots-at-companies-failing-cfo/
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://veracode.com/blog/genai-code-security-report/
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://apiiro.com/blog/4x-velocity-10x-vulnerabilities-ai-coding-assistants-are-shipping-more-risks/
...
- **Beleg im Original:** _(kein wörtlicher Quelltext automatisch auffindbar — siehe Fundstelle/Quell-Link)_
- **Quell-Link:** https://gitclear.com/ai_assistant_code_quality_2025_research
